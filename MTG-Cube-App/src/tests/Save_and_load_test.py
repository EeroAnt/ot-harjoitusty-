...
class TestSavingAndLoading(unittest.TestCase):
    ...
    def test_loading_from_list(self):
        self.assertEqual(self.cube.card_names, ['Blood Scrivener', 'Bloodthrone Vampire', 'Burglar Rat', 'Caligo Skin-Witch', 'Dauthi Horror', 'Dauthi Slayer', 'Dregscape Zombie', 'Dusk Legion Zealot', 'Gnawing Zombie', 'Golgari Thug', 'Pack Rat', 'Hydroblast', 'Mizzium Skin', 'Opt', 'Ponder', 'Preordain', 'Serum Visions', 'Sleight of Hand', 'String of Disappearances', 'Stubborn Denial', 'Swan Song', 'Anafenza, Kin-Tree Spirit', 'Eight-and-a-Half-Tails', 'Carnival // Carnage'])
